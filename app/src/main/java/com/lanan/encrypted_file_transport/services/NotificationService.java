			...
			public void run() {
				while (true){
					...
					try {
                        ...
                        for (String i : serverSocket.getEnabledCipherSuites()){
                            Log.d("Emilio", "Cipher:" + i);
                        }
					} catch (Exception e){
						e.printStackTrace();
					}
...
//                serverSocket.setEnabledCipherSuites(new String[]{"SSL_KGM_WITH_GMCIPHER_GMHASH"});
//                serverSocket.setEnabledCipherSuites(new String[]{"SSL_RSA_WITH_DES_CBC_SHA"});
//				String[] cs = serverSocket.getEnabledCipherSuites();
//
